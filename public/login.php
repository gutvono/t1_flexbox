...
<body class="auth-wrapper">
  <section class="auth-card">
    <h1 class="mb-3 text-center" style="color: var(--secondary-color)">Bem-vindo ao Steemo</h1>
    <form method="POST" action="./handle_login.php" class="needs-validation" novalidate>
      ...
      <button class="btn btn-gradient w-100 mb-2" type="submit">LOGIN</button>
      <div class="d-flex justify-content-between align-items-center">
        <a class="btn btn-link p-0" href="./register.php">Cadastre-se</a>
